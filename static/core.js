...
function requireAdminAuth() {
  if (!localStorage.getItem('admin_token')) { window.location.href = 'admin-login.html'; return false; }
  return true;
}

// requireCustomerAuth() — call at the top of every customer-*.html page
function requireCustomerAuth() {
  if (!localStorage.getItem('customer_token')) { window.location.href = 'customer-login.html'; return false; }
  return true;
}
...
// formatDate() — converts ISO date to "Mar 15, 2026"
// Appending T12:00:00 to date-only strings prevents timezone off-by-one
// where "2026-03-15" could render as "Mar 14" in some US timezones.
...
// formatDatetime() — converts ISO timestamp to "Mar 9, 2026, 10:00 AM"
