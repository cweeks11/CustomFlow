...
function renderCustomerNav(active) {
  ...
  drop.innerHTML = `
    ...
    <div class="nav-drop-mobile-divider" style="display:none;height:1px;background:var(--b1);"></div>
    <button onclick="logoutCustomer()" style="width:100%;text-align:left;padding:11px 16px;font-size:13px;color:var(--err);background:none;border:none;cursor:pointer;font-family:var(--fd);border-top:1px solid var(--b1);display:flex;align-items:center;gap:10px;">🚪 Log Out</button>`;
  document.body.appendChild(drop);
